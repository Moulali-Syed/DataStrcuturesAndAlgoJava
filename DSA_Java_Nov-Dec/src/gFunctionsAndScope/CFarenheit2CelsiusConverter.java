 ...
 */
public class CFarenheit2CelsiusConverter {

	public static void main(String[] args) {
		Scanner s = new Scanner(System.in);
		int startFarhenheit = s.nextInt();
		int endFarhenheit = s.nextInt();
		int step = s.nextInt();
		
		calculateF2C(startFarhenheit,endFarhenheit,step);
	}

	public static void calculateF2C(int startFarhenheit, int endFarhenheit, int step) {
		//(5/9)*(Fahrenheit Value - 32)
		for(int i=startFarhenheit;i<=endFarhenheit;i+=step) {
			double res = (5/9.0)*(i-32);
